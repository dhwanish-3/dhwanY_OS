...
load --int=15 $HOME/myexpos/Stage22/Assgn2/int15.xsm
...
load --module 5 $HOME/myexpos/Stage22/Assgn2/mod5.xsm
load --module 7 $HOME/myexpos/Stage22/Assgn2/mod7.xsm
load --module 0 $HOME/myexpos/Stage22/Assgn2/mod0.xsm
...
load --int=timer $HOME/myexpos/Stage22/Assgn2/timer.xsm
rm test4.xsm
